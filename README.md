...
- **主站地址**：https://guanxin-mu.vercel.app/
...
- 日本和海外访问：优先使用 Vercel 主站 `https://guanxin-mu.vercel.app/`
- 中国大陆正式上线：后续需要单独评估域名备案、国内云部署、模型合规与内容安全策略
